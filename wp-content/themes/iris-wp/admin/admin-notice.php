...
<div class="iris-wp-notice-dont-show-container">
    <button class="button-link iris-wp-dont-show-notice">
		<?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
    </button>
</div>

<div class="iris-wp-admin-notice-spacer">
    <div class="iris-wp-admin-big-notice--container">
        <div class="content-holder">
            <div class="messages-area">
                <div class="title-holder">
                    <h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', iris_wp_theme()->getName() ); ?></h1>
                    <p><?php Translations::escHtmlE( 'theme_description', iris_wp_theme()->getName() ); ?></p>
                </div>

                <ul>
                    <li>
                        <img src="<?php echo iris_wp_theme()->getListMarkerUrl()?>" alt="">
            ...
            <div class="front-page-preview">
                <img src="<?php echo esc_url( iris_wp_theme()->getFrontPagePreview() ); ?>"/>
            </div>
        </div>
    </div>
</div>
