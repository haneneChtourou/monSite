...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer iris-wp-front-header__k__c6BbujDIAOY-outer iris-wp-local-150-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
  ...
  'wrapper_class' => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row iris-wp-front-header__k__afIZ7lcsb-container iris-wp-local--container',
  'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  iris-wp-front-header__k__afIZ7lcsb-image iris-wp-local--image',
  'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   iris-wp-front-header__k__afIZ7lcsb-alternateImage iris-wp-local--alternateImage',
  'logo_text_class' => 'position-relative wp-block-kubio-logo__text  iris-wp-front-header__k__afIZ7lcsb-text iris-wp-local--text',
)); ?>
										</div>
									</div>
								</div>
								...
								<div class="wp-block wp-block-kubio-column  position-relative wp-block-kubio-column__container iris-wp-front-header__k__7AuOkWajPWG-container iris-wp-local-160-container d-flex h-col-lg-auto h-col-md-auto h-col-auto" data-kubio="kubio/column">
									<div class="position-relative wp-block-kubio-column__inner iris-wp-front-header__k__7AuOkWajPWG-inner iris-wp-local-160-inner d-flex h-flex-basis h-px-lg-2 v-inner-lg-2 h-px-md-2 v-inner-md-2 h-px-2 v-inner-2">
										...
										<div class="position-relative wp-block-kubio-column__align iris-wp-front-header__k__7AuOkWajPWG-align iris-wp-local-160-align h-y-container h-column__content h-column__v-align flex-basis-100 align-self-lg-center align-self-md-center align-self-center">
											<?php iris_wp_theme_print_menu_footer_copyright(); ?>
										</div>
									</div>
								</div>
							</div>
