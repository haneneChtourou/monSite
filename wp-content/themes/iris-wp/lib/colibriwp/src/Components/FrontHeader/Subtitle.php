		...
		return array(
			...
			'settings' => array(
				...
				"{$prefix}localProps.content" => array(
					'default' => __('Unlock your full potential and transform the way you work with our innovative platform. Try it today and experience the difference firsthand.', 'iris-wp'),
					'control' => array(
